...
sys.path.append(f"{current_dir}/ddim.py")
sys.path.append(f"{current_dir}/ddpm_torch.py")
...
def main():
    ...
    parser.add_argument("--attack_norm", default="inf", type=str, choices=["inf", "2"], help="norm to use for the adversarial attack")
    parser.add_argument('--config-attack', default='NSR', type=str, choices=['NSR', 'NSR-post'], help='attack to use')
    parser.add_argument("--wandb-id", default=None, type=str, help="wandb id to resume a run")
    parser.add_argument("--wandb-log", action="store_true", help="whether to log to wandb")
