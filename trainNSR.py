...
def train(rank=0, args=None, temp_dir=""):
    ...
    exp_name = "".join(
        [args.exp_name, "-", datetime.now().strftime("%Y-%m-%dT%H%M%S%f")]
    )
...
def main():
    ...
    parser.add_argument(
        "--root",
        default="/home/hl-fury/mariarosaria.briglia/ddpm-torch/data",
        type=str,
    ...
    parser.add_argument(
        "--image-dir",
        default="/home/hl-fury/maria.briglia/data/ddpm-train/images/flag",
        type=str,
    )
    ...
    parser.add_argument(
        "--chkpt-dir",
        default="/home/hl-fury/maria.briglia/data/ddpm-train/chkpt-dir/flag",
        type=str,
    )
    parser.add_argument("--chkpt-name", default="", type=str)
    parser.add_argument(
        "--chkpt-intv", default=10, type=int, help="frequency of saving a checkpoint"
    )
    ...
    parser.add_argument(
        ...
        default=1,
        type=float,
        help="percentage of adversarial examples in the training procedure",
    )
    parser.add_argument(
        "--architecture",
        default="unet",
        type=str,
        choices=model_instanciations.keys(),
    ...
    parser.add_argument(
        ...
        type=str,
        choices=["inf", "2"],
        help="norm to use for the adversarial attack",
    )
    parser.add_argument(
        "--config-attack",
        default="NSR",
        type=str,
        choices=["NSR", "NSR-post"],
        help="attack to use",
    )
    parser.add_argument(
        "--wandb-id", default=None, type=str, help="wandb id to resume a run"
    )
    parser.add_argument(
        "--wandb-log", action="store_true", help="whether to log to wandb"
    )
...
python train.py --dataset cifar10 --attack NSR --chkpt-intv 10 --root /home/maria.briglia/data/adv-ddpm-train --exp-name adv-flag --chkpt-dir /home/maria.briglia/data/adv-ddpm-train/chkpts --adv-percentage 1 --image-dir /home/maria.briglia/data/adv-ddpm-train/images
"""
