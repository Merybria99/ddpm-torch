...
base_image_dir = '/home/hl-fury/mariarosaria.briglia/ddpm-torch/images/SSIM retrieval'
try:
    ...
    dataset = 'cifar10'
    config_dir = './configs'    
    chkpt_path = '/home/hl-fury/mariarosaria.briglia/ddpm-torch/models/adv-ddpm/L2/UNet/cifar10/cifar10_2040.pt'
    chkpt_dir = chkpt_path.rstrip("/")
    use_ddim = False
...
# save the grid plot 
plt.savefig(f'{base_image_dir}/grid_plot_2040_L2.png')
