...
class CelebA(tvds.VisionDataset):
    ...
    def get_subset(self, percentage):
        # set seed to make sure the subset is always the same
        np.random.seed(123)
        
        n = int(len(self) * percentage)
        return Subset(self, np.random.choice(len(self), n, replace=False))
...
def get_dataloader(
    ...
    **kwargs,
    ...
    if dataset_name == "celeba":
        ...
        dataset = dataset.get_subset(0.3)
        print("Using subset of CelebA dataset with 30% of the data")
